...
NOV. 2023 UPDATE: An advanced draft is now available of the new  [*Lessons in Statistical Thinking*](https://dtkaplan.github.io/Lessons-in-statistical-thinking/) introductory text and the associated `{LST}` R package. This is a complete rethinking of introductory statistics that places it in the context of data science, modeling, and causal inference.
